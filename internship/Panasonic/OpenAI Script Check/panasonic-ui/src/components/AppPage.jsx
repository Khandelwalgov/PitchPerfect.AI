  ...
  const startRecording = async () => {
    ...
    mediaRecorder.current.onstop = async () => {
      ...
      try {
        ...
        setEnglishTranslation(data.score || "[No English translation returned]");
        setReviewFeedback(data.review || "[No review feedback returned]");
      } catch (err) {
    ...
    <div className="app-container">
      ...
      <div className="app-card">
        ...
        <div className="sections">
          ...
          <Section title="Review Feedback" content={reviewFeedback} />
        </div>
      </div>
    </div>
  );
